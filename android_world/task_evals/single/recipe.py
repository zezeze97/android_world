...
class RecipeAddTwentyMinuteRecipe(RecipeAddThirtyMinuteRecipe):
  """Task to add one recipe with a 20-minute preparation time."""

  target_prep_time = '20 mins'


class RecipeAddTwoSmallServingRecipes(RecipeAddTwoFamilyServingRecipes):
  """Task to add two recipes with a small servings field."""

  target_servings = '2 servings'


class RecipeDeleteTwentyMinuteRecipes(RecipeDeleteThirtyMinuteRecipes):
  """Task to delete recipes with a 20-minute preparation time."""

  target_prep_time = '20 mins'


class RecipeAddRecipesFromMarkorWithChicken(RecipeAddRecipesFromMarkorWithIngredient):
  """Task to add only chicken recipes from a Markor note."""
