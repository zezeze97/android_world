...
class ExpenseAddTransportationPurchase(_ExpenseAddMultiple):
  """Task to add a single Transportation-category expense."""
  ...
  @classmethod
  def _get_random_target_row(cls) -> sqlite_schema_utils.Expense:
    return _generate_expense(category_id=7)
...
class ExpenseAddTwoHealthCareExpenses(_ExpenseAddMultiple):
  """Task to add two Health Care expenses."""
  ...
  @classmethod
  def _get_random_target_row(cls) -> sqlite_schema_utils.Expense:
    return _generate_expense(category_id=9)
...
class ExpenseDeleteHousingExpenses(ExpenseDeleteEntertainmentExpenses):
  """Task to delete only Housing expenses among other expenses."""

  target_category_id = 4


class ExpenseDeleteTransportationExpenses(ExpenseDeleteEntertainmentExpenses):
  """Task to delete only Transportation expenses among other expenses."""
